...
window_width = 1280
window_height = 720
imgBackground = cv2.resize(imgBackground, (window_width, window_height))
...
while True:
    ...
    # Resize webcam frame to exactly 480x640
    frame_resized = cv2.resize(frame, (640, 480))

    # Overlay correctly on background
    imgBackground[100:100+480, 150:150+640] = frame_resized
    ...
    if k == ord('2'):
        ...
        if exist:
            ...
            with open("Votes" + ".csv", "+a") as csvfile:
                ...
                writer.writerow(attendance)
                csvfile.close()
            speak("THANK YOU FOR PARTĚCIPATING IN THE ELECTIONS")
            break
